    ...
    <Box className="container" component="section" id="studio">
      ...
      <Box sx={styles.imageWrapper}>
        <Box sx={styles.imageContainer}>
          ...
          />
          <Box sx={styles.imageText}>Photography Studio</Box>
        </Box>
        <Box sx={styles.imageContainer}>
          <Box
            sx={styles.image}
          ...
          />
          <Box sx={styles.imageText}>Podcast Studio</Box>
        </Box>
        <Box sx={styles.imageContainer}>
          <Box
            sx={styles.image}
          ...
          />
          <Box sx={styles.imageText}>Makeup Studio</Box>
        </Box>
        <Box sx={styles.imageContainer}>
          <Box
            sx={styles.image}
          ...
          />
          <Box sx={styles.imageText}>Cooking Studio</Box>
        </Box>
      </Box>
    </Box>
  );
